        ...
        <div class="space-x-4">
            <Menu as="div" class="relative inline-block text-left">
                ...
                <transition enter-active-class="transition duration-100 ease-out"
                    ...
                    <MenuItems
                        class="absolute right-0 mt-2 w-36 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg
                        ...
                        <div class="px-1 py-1">
                            <MenuItem v-slot="{ active }">
                                ...
                                'group flex w-full items-center rounded-md px-2 py-2 text-sm',
                                    ...
                                    <ArrowLeftStartOnRectangleIcon :active="active" class="mr-2 h-5 w-5 text-indigo-400" aria-hidden="true" />
                                    Logout
                                </button>
                            </MenuItem>
                        </div>
...
import LanguageDropdown from "./core/LanguageDropdown.vue";
