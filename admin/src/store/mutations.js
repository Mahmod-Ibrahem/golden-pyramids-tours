...
export function setContactLeads(state, data) {
    state.contactLeads.data = data.data
    state.contactLeads.loading = false
    state.contactLeads.from = data.meta.from
    state.contactLeads.to = data.meta.to
    state.contactLeads.total = data.meta.total
    state.contactLeads.links = data.meta.links
}
