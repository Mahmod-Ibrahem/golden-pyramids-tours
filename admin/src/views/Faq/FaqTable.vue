<template>
    <div class="managmenet_container">
        <table class="table_tag">
            ...
            <tr v-for="(faq, index) of Faqs.data">
                <td class="border-b p-2 max-w-[200px] whitespace-nowrap overflow-hidden text-ellipsis">{{ faq.id }}</td>
                            ...
                            <MenuItems
                                ...
                                <div class="px-1 py-1">
                                    <MenuItem v-slot="{ active }">
                                        <RouterLink :to="{ name: 'app.faq.translate', params: { id: faq.id } }"
                                                    :class="[
                                    ...
                                    <MenuItem v-slot="{ active }">
                                        <RouterLink :to="{ name: 'app.faq.edit', params: { id: faq.id } }"
                                                    :class="[
                                                active ? 'bg-indigo-600 text-white' : 'text-gray-900',
                                                'group flex w-full items-center rounded-md px-2 py-2 text-sm',
                                            ]">
