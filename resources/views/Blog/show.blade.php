...
@section('content')
    ...
    <div class="h-[20rem] md:h-screen w-full ">
        <div
            ...
            style="background-image: url('{{ $city->image }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">
            <div
    ...
    <div class="child_container py-6 md:py-12">
        @forelse($cityAttractions as $attraction)
            @component('components.BlogCard' ,['attraction'=>$attraction])@endcomponent
        @empty
            Soon
        @endforelse
    </div>
