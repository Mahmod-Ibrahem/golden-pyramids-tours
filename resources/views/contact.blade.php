            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 grid-cols-1">
                                ...
                                <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div class="bg-white rounded-lg p-6 block">
                                        <a class="flex items-center mb-6">
                                            <svg class="h-7 w-7 text-bg-main"
                                        ...
                                        <a class="flex items-center">
                                            <svg class="h-7 w-7 text-bg-main" fill="none" viewBox="0 0 24 24"
                                                 stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                      d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                            </svg>
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">
                                                info@GoldenPyramidsTravel.com</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                        <h2 class="text-3xl font-semibold leading-10 mb-11 text-main">{{__('Send Us a Message')}}</h2>
                        <input type="text" name="name"
                               class="w-full h-12 text-gray-600 placeholder-gray-400  shadow-sm bg-transparent text-lg font-normal leading-7
                               rounded-full border border-gray-200 focus:outline-bg-main pl-4 mb-10"
                               placeholder="{{__('Name')}}">
                        <input type="text" name="email"
                               class="w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-bg-main pl-4 mb-10"
                               placeholder="{{__('Email')}}">
                        <input type="text" name="phone"
                               class="w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-bg-main pl-4 mb-10"
                               placeholder="{{__('Phone')}}">
                        <div class="mb-5">
                            <h4 class="text-gray-500 text-lg font-normal leading-7 mb-4">{{__('Preferred method of communication')}}</h4>
                            <div class="flex">
                        ...
                        shadow  font-medium bg-white border border-gray-200 focus:outline-bg-main"
                                  placeholder={{__('Write your message here...')}}></textarea>


                        <button
                            class="main_button bg-bg-main py-3 uppercase shadow-[0px_5px_0px_0px_rgba(0,0,0,0.25)] shadow-yellow-800 hover:shadow-none
                             hover:translate-y-[5px] transition-all duration-1000 text-secondary w-full">
                            {{__('Send')}}
                        </button>
                    </div>
