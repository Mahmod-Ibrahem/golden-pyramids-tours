        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <div class="flex justify-center gap-0.5 text-green-500">
                    <svg class="w-4 h-4 text-[#ff6700] me-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="mt-0.5 text-lg font-medium text-gray-900">{{$review->reviewer}}</p>
            </div>
        </div>

        <divz
            class="max-w-[300px] min-h-[300px]  line-clamp-[15] whitespace-normal overflow-hidden flex-col review_description">
            <p class="font-medium text-[#ff6700] mt-2">{{$review->title}}</p>
